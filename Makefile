WEIGHT_PATH='checkpoints/Yolov4_epoch52.pth'
TINY_PATH='tiny_utils/checkpoints/Yolov4_epoch75.pth'
IMG='test1.jpg'
CLASSES=1
yolorun:
	python3 yolov4_train.py -l 0.001 -g 0 -pretrained weights/yolov4.conv.137.pth -classes 1 -dir Ds
